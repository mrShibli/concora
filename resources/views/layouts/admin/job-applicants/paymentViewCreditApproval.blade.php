                ...
                <div class="form-details">
                        ...
                        <form action="{{ route('applicants.updateBalance', $applicant->id) }}" method="POST">
                            ...
                            <div class="lefttabcontent">
                                ...
                                <div class="form-group payableinput">
                                    ...
                                    <div><span class="highlight-black">
                                            <input type="text" name="slip_invoice_number" value="{{ $payment->recomNote }}" required>
                                        </span></div>
                                </div>
                                <input type="hidden" name="applicant_id" value="{{ $applicant->id }}">
                                <input type="hidden" name="is_payment" value="yes">
                                <input type="hidden" name="pay_activity_id" value="{{ $payment->id }}">
                                <!-- Hidden input for pay_activity_id -->
                                <div class="submitbuttonarea">
                                    {{-- <button type="submit" name="submit">Balance Update <img
                            ...
                            <div class="upload-container">
                                <div class="invoicefles">
                                    ...
                                    <a href="{{ asset($payment->slip_invoice_file) }}" data-lightbox="payment"
                    ...
                    <div class="tab-content" id="req-credit" style="display: none;">
                        @if (in_array($applicant->reference, ['LS1994ND40', 'QM1990ZD12', 'WK1978SI41', 'GK1980MM51']))
                            <form action="{{ route('applicants.approveBalanceApproval', $applicant->id) }}" method="post"
                                ...
                                <div class="lefttabcontent">
                                    ...
                                    <div class="form-group">
                                        <label>Walltet Balance</label>
                                         <div><span class="highlight-green">AED {{ $payment->deposit_amount }}</span>
                                        </div>
                                        <input type="hidden" name="pay_activity_id" value="{{ $payment->id }}">
                                        <!-- Hidden input for pay_activity_id -->
                                    ...
                                    <div class="submitbuttonarea">
                                        ...
                                        <button type="submit" name="submit"> Request Approve <img
                                                src="{{ asset('submit.svg') }}" width="20" alt=""> </button>
                                    </div>
                                </div>
                                <div class="upload-container" style="border:none;">
                                    ...
                                    <div class="upload-button">
                                        <div class="upload-info" style="min-width: 250px;">
