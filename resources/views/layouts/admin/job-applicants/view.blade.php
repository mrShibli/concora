...
@section('content')
    <div class="right-side m-4 Laptop:m-4 pt-20 Laptop:pt-[5.4rem] ml-4 Tablet:ml-[205px] Laptop:ml-[235px]">
        ...
        <div class="breadcums mb-3 ml-2 Tablet:mt-[-5px]">
            <div class="">
                <a href="{{ route('dashboard') }}" class="text-xs text-blue-600 hover:underline">Home /</a> <a href="{{ route('applicants.index') }}"
                    class="text-xs text-blue-600 hover:underline">Applicants /</a> <a href=""
            ...
            <div  class="flex gap-6 flex-wrap my-6" >
                <table class="w-[62%] Tablet:w-[70%]">
                    ...
                    <tr class="border">
                        ...
                        <td class="border p-1.5 pl-2 text-xs Laptop:text-sm">{{ $applicant->created_at->format('F d, Y') }}</td>
                    </tr>
                    <tr class="border">
                        <td class="border p-1.5 pl-2 text-xs Laptop:text-sm">Nationality</td>
                        <td class="text-xs Tablet:text-sm Laptop:text-base p-1 Tablet:p-2 flex gap-2">{{ $applicant->nationality }} </td>
                    </tr>
                    <tr class="border">
                        <td class="border p-1.5 pl-2 text-xs Laptop:text-sm">Full Name</td>
                        <td class="border p-1.5 pl-2 text-xs Laptop:text-sm">{{ $applicant->first_name }} {{ $applicant->last_name }}</td>
                    </tr>
                    <tr class="border">
            ...
            <div class="flex gap-2 flex-wrap my-6"> 
                ...
                <div class="images w-[30%] Tablet:w-[25%]">
                    <div class="">
                        <div class="info ">
                            <div class="image flex items-center gap-6 ">
                                <img src="{{ asset('applicants/' . $applicant->appli_dri_lisence_frontpart) }}" alt=""
                                    class="w-8 h-10 object-contain Tablet:w-12 Tablet:h-14 Laptop:w-20 Laptop:h-20">
                                <a href="" class="text-xs Tablet:text-sm">View </a>
                            </div>
                        ...
                        <div class="info  mt-3">
                            <div class="image flex items-center gap-6">
                                <img src="{{ asset('applicants/' . $applicant->appli_dri_lisence_backpart) }}" alt=""
                                    class="w-8 h-10 object-contain Tablet:w-12 Tablet:h-14 Laptop:w-20 Laptop:h-20">
                                <a href="" class="text-xs Tablet:text-sm">View </a>
                            </div>
